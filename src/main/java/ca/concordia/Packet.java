...
public class Packet {
    ...
    public static final int PACKET_TYPE_ACK = 0;
    public static final int PACKET_TYPE_SYN = 1;
    public static final int PACKET_TYPE_SYN_ACK = 2;
    public static final int PACKET_TYPE_DATA_START = 3;
    public static final int PACKET_TYPE_DATA = 4;
    public static final int PACKET_TYPE_DATA_END = 5;
    public static final int PACKET_TYPE_RECEIVE_DATA_START = 6;
    public static final int PACKET_TYPE_RECEIVE_DATA_END = 7;
    public static final int PACKET_TYPE_RESPONSE = 7;

    /*
     * 0:ACK,1:SYN,2:SYN-ACK,3:DATA,4:ENDPACKET
     */
    ...
    public String toString() {
        return String.format("@%d #%d peer=%s:%d, size=%d", type, sequenceNumber, peerAddress, peerPort, payload.length);
    }
